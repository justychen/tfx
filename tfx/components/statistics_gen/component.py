  ...
  def __init__(self,
    ...
    Args:
      ...
      stats_options: The StatsOptions instance to configure optional TFDV
        behavior. Note that passing custom slicer functions or stats generators
        will not work if TFDV is executing in a distributed setting due to
        unavailability of custom code on worker machines.
    ...
    spec = StatisticsGenSpec(
        examples=examples, stats_options=stats_options, statistics=output)
