...
class StatisticsGen(base_component.BaseComponent):
  ...
  def __init__(self,
               ...
               problem_statement: Optional[
                   problem_statement_pb2.ProblemStatement] = None,
    ...
    Args:
      ...
      problem_statement: A problem statement to use for automatically
        configuring the value of stats options passed to TFDV.
      schema: A schema to use for automatically configuring the value of stats
        options passed to TFDV.
    """
    if input_data:
